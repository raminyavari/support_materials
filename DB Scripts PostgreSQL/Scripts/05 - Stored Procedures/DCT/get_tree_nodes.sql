DROP FUNCTION IF EXISTS dct_get_tree_nodes;

CREATE OR REPLACE FUNCTION dct_get_tree_nodes
(
...
BEGIN
	vr_ids := ARRAY(
		...
		WHERE tn.application_id = vr_application_id AND tn.tree_id = vr_tree_id AND deleted = FALSE
