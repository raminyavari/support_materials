DROP FUNCTION IF EXISTS qa_my_favorite_questions;

CREATE OR REPLACE FUNCTION qa_my_favorite_questions
(
...
BEGIN
	...
	(
		...
		WHERE f.application_id = vr_application_id AND f.user_id = vr_user_id
	),
	total AS
	(
