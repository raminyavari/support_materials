DROP FUNCTION IF EXISTS wf_get_workflow_connections;

CREATE OR REPLACE FUNCTION wf_get_workflow_connections
(
...
BEGIN
	...
	RETURN QUERY
	SELECT *
	FROM wf_p_get_workflow_connections(vr_application_id, vr_workflow_id, vr_ids);
END;
$$ LANGUAGE plpgsql;
